...
public class Studentclass implements Comparable<Studentclass> {
	...
	/*
	 * here we Override tostring method and print with the help of string.format in
	 * good manner;
	 */
	@Override
...
//		return String.format("%-20s%-10d%-10d%-20s", name, age, rank, address);
		...
		return String.format("%-20s  |  %-20d  |  %-10d  |  %-30s  |",  this.name, this.age, this.rank, this.address );
	}
	...
	public boolean equals(Object obj) {
		if (obj != null) {
			...
			if (this.registrationNumber == s.registrationNumber) {
				return true;
			}
		}
		return false;
